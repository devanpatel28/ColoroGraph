...
public class Elvl3 extends AppCompatActivity {
    ...
    public void check(View view)
    {
        ...
        else if((v1==v2)||(v2==v3)||(v3==v4)||(v4==v5)||(v5==v1))
        {
            errorSound();
            mydialog = new Dialog(this);
            mydialog.setCancelable(true);
    ...
    public void nextlvl(View view)
    {
        tapSound();
        clrAll(view);
        Intent intent = new Intent(Elvl3.this,Elvl4.class);
    ...
    {
        tapSound();
        Intent intent = new Intent(Elvl3.this,LevelEasy.class);
        startActivity(intent);
    }
