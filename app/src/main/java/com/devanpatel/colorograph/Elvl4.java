...
public class Elvl4 extends AppCompatActivity {
    ...
    public void nextlvl(View view)
    {
        tapSound();
        clrAll(view);
        Intent intent = new Intent(Elvl4.this,Elvl5.class);
    ...
    {
        tapSound();
        Intent intent = new Intent(Elvl4.this,LevelEasy.class);
        startActivity(intent);
    }
    @Override
