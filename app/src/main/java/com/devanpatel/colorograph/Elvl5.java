...
public class Elvl5 extends AppCompatActivity {
    ...
    public void check(View view)
    {
        ...
        else if((v1==v2)||(v2==v3)||(v3==v4)||(v3==v5))
        {
            errorSound();
            mydialog = new Dialog(this);
            mydialog.setCancelable(true);
    ...
    {
        tapSound();
        Intent intent = new Intent(Elvl5.this,LevelEasy.class);
        startActivity(intent);
    }
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_elvl5);
    }
